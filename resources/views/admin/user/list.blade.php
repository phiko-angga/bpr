@extends('admin.layout._template',['title' => 'List User - Admin Panel'])
@section('content')
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 grid-margin">
                        <div class="d-flex justify-content-between align-items-end flex-wrap">
                            <div class=" me-3"><a href="{{route('users.create')}}" class="btn btn-outline-primary btn-fw btn-sm">Add User</a></div>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        @include('admin.user.list_pagination')
                    </table>
                </div>
            </div><!-- /.box-body -->
        </div><!-- /.box -->
...
<script>
  ...
  $('.delete_btn').click(function(e){
    ...
    modalConfirm.find('form').attr('action','{{url('')}}/adminpanel/users/'+$(this).data('id'));
